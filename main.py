...
if __name__ == "__main__":
    ...
    fr1.pack(side='right')
    r0 = tk.Radiobutton(fr1, text='0.1min', variable=var, bg='LightGreen', value=0.1*60)
    r0.pack()
    r1 = tk.Radiobutton(fr1, text='30min', variable=var, bg='LightGreen', value=25*60)
    r1.pack()
    r2 = tk.Radiobutton(fr1, text='45min', variable=var, bg='LightGreen', value=40*60)
    r2.pack()
    r3 = tk.Radiobutton(fr1, text='60min', variable=var, bg='LightGreen', value=55*60)
    r3.pack()
    # TODO
